"""tests/test_create_notebook_getting_started.py"""
...
from create_notebook_getting_started import (
    build_getting_started_notebook,
    getting_started_slug,
    getting_started_title,
)
from create_notebook_getting_started import write_kernel_metadata as write_gs_metadata
...
class TestWriteKernelMetadataGettingStarted:
    def test_creates_metadata_file(self, tmp_path: Path) -> None:
        with patch("create_notebook_getting_started.notebook_output_dir", return_value=tmp_path):
...
class TestMainCreateGettingStarted:
    def test_main_creates_notebook_and_metadata(self, tmp_path: Path) -> None:
        import create_notebook_getting_started
