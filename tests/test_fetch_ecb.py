...
========================
Unit tests for scripts/fetch_ecb.py
...
class TestFetchRawCsvRetry:
    ...
    def test_raises_immediately_on_400(self) -> None:
        """4xx errors should not trigger a retry."""
    ...
    def test_raises_after_max_attempts(self) -> None:
        """Persistent timeouts should eventually raise after all retries."""
        with patch(
            "fetch_ecb.requests.get",
...
class TestParseEcbCsv:
    ...
    def test_drops_missing_rates(self) -> None:
        ...
        assert len(df) == 4   # missing row dropped
